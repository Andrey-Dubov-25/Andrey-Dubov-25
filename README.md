...
<p align="center">
  ...
  <a href="https://github.com/Andrey-Dubov-25/portfolio"><img src="https://img.shields.io/badge/Portfolio-181717?style=for-the-badge&logo=github&logoColor=white"></a>
</p>
...
Я - backend-разработчик, специализируюсь на Python. Пришёл в разработку из менеджмента — во время учёбы понял, что хочу не управлять процессами, а создавать продукты. Самостоятельно изучал Python на Stepik, затем прошёл обучение в Яндекс.Практикуме, сейчас развиваюсь в профессиональной команде.

- 🔭 Сейчас работаю над пет-проектами на Django (DRF) и FastAPI
- 🌱 Изучаю продвинутое ООП и лучшие практики построения API
- 💬 Могу обсудить Python, Django, REST API, PostgreSQL, Docker
- 📍 Владимир, Россия · открыт к удалённой и гибридной работе
